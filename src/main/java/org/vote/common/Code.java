...
public class Code {
  ...
  public static void initialize() {
    ...
    // 忘记密码功能返回码
    codes.put(2100, "我们已向您的邮箱发了一封邮件，请注意查收"); 
    codes.put(2101, "操作失败原因未知"); 
    codes.put(2102, "用户不存在"); 

    // 修改用户信息功能返回码
    codes.put(2200, "修改用户信息成功"); 
    codes.put(2201, "修改用户信息失败原因未知"); 
    codes.put(2202, "无权修改信息"); 
